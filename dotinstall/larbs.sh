...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/bilgehankaya/dotins.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/bilgehankaya/dotins/master/progs.csv"
