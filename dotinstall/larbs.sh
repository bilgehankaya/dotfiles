...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/bilgehankaya/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/bilgehankaya/dotfiles/master/dotinstall/progs.csv"
